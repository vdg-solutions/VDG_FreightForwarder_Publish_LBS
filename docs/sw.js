...
const STATIC_CACHE     = 'vdg-static-vfdc0a40';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vfdc0a40';
...
// versioned with STATIC_CACHE (a redeploy bumps fdc0a40 → activate drops the old cache →

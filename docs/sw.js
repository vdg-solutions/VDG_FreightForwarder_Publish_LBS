...
const STATIC_CACHE     = 'vdg-static-vfe1bf13';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vfe1bf13';
...
// versioned with STATIC_CACHE (a redeploy bumps fe1bf13 → activate drops the old cache →

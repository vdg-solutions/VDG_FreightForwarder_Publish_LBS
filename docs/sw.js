...
const STATIC_CACHE     = 'vdg-static-v1fd3cec-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v1fd3cec-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps 1fd3cec-dirty → activate drops the old cache →

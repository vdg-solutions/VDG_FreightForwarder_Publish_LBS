...
const STATIC_CACHE     = 'vdg-static-v8ee8a2b-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v8ee8a2b-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps 8ee8a2b-dirty → activate drops the old cache →

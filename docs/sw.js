...
const STATIC_CACHE     = 'vdg-static-vaaa7bbb';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vaaa7bbb';
...
// versioned with STATIC_CACHE (a redeploy bumps aaa7bbb → activate drops the old cache →

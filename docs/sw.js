...
const STATIC_CACHE     = 'vdg-static-v1bade76';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v1bade76';
...
// versioned with STATIC_CACHE (a redeploy bumps 1bade76 → activate drops the old cache →

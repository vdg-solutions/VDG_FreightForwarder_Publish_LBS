...
const STATIC_CACHE     = 'vdg-static-v7d1e83d';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v7d1e83d';
...
// versioned with STATIC_CACHE (a redeploy bumps 7d1e83d → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v1474f64-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v1474f64-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps 1474f64-dirty → activate drops the old cache →

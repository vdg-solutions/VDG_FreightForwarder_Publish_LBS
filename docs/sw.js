...
const STATIC_CACHE     = 'vdg-static-vfd48beb';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vfd48beb';
...
// versioned with STATIC_CACHE (a redeploy bumps fd48beb → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-vd5aaeca';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vd5aaeca';
...
// versioned with STATIC_CACHE (a redeploy bumps d5aaeca → activate drops the old cache →

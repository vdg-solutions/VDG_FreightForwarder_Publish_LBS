...
const STATIC_CACHE     = 'vdg-static-vb43eec6-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vb43eec6-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps b43eec6-dirty → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v7f9d5ab';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v7f9d5ab';
...
// versioned with STATIC_CACHE (a redeploy bumps 7f9d5ab → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-vfddaca8';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vfddaca8';
...
// versioned with STATIC_CACHE (a redeploy bumps fddaca8 → activate drops the old cache →

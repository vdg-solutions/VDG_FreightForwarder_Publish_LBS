...
const STATIC_CACHE     = 'vdg-static-v5e5c835';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v5e5c835';
...
// versioned with STATIC_CACHE (a redeploy bumps 5e5c835 → activate drops the old cache →

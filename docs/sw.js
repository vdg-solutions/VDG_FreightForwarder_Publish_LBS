...
const STATIC_CACHE     = 'vdg-static-vf5a8da0';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vf5a8da0';
...
// versioned with STATIC_CACHE (a redeploy bumps f5a8da0 → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-vec18a46';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vec18a46';
...
// versioned with STATIC_CACHE (a redeploy bumps ec18a46 → activate drops the old cache →

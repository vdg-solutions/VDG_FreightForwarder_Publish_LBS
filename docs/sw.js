...
const STATIC_CACHE     = 'vdg-static-vd1e2aaa';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vd1e2aaa';
...
// versioned with STATIC_CACHE (a redeploy bumps d1e2aaa → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-va5ec17f';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-va5ec17f';
...
// versioned with STATIC_CACHE (a redeploy bumps a5ec17f → activate drops the old cache →

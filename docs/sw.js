...
const STATIC_CACHE     = 'vdg-static-v1ffe5f3';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v1ffe5f3';
...
// versioned with STATIC_CACHE (a redeploy bumps 1ffe5f3 → activate drops the old cache →

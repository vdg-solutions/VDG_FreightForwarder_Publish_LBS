...
const STATIC_CACHE     = 'vdg-static-vf83f1a3';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vf83f1a3';
...
// versioned with STATIC_CACHE (a redeploy bumps f83f1a3 → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v812b4fe';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v812b4fe';
...
// versioned with STATIC_CACHE (a redeploy bumps 812b4fe → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v0bad457';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v0bad457';
...
// versioned with STATIC_CACHE (a redeploy bumps 0bad457 → activate drops the old cache →

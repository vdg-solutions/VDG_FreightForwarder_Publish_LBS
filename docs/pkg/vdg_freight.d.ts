...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_16765: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_16778: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12274: (a: number, b: number) => void;

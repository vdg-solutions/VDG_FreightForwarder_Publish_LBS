...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9718: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9720: (a: number, b: number, c: number, d: number) => void;

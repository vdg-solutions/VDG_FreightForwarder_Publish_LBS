...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15515: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15528: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12678: (a: number, b: number) => void;

...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_10793: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_10795: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4613: (a: number, b: number) => void;

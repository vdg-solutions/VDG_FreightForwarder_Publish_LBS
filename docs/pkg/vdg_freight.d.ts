...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15679: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15692: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12842: (a: number, b: number) => void;

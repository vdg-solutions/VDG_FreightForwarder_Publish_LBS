...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15678: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15691: (a: number, b: number, c: number, d: number) => void;

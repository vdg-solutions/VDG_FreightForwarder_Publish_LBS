...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_16794: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_16807: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12303: (a: number, b: number) => void;

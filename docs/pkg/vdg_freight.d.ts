...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15505: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15507: (a: number, b: number, c: number, d: number) => void;

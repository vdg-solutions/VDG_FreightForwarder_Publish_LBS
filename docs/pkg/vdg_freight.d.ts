...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_13970: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_13972: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_10024: (a: number, b: number) => void;

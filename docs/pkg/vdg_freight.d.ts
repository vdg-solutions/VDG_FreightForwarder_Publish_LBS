...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15681: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15694: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12844: (a: number, b: number) => void;

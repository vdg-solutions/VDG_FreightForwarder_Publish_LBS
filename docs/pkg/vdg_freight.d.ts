...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9731: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9733: (a: number, b: number, c: number, d: number) => void;

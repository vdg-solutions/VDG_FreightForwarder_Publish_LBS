...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15549: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15562: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12712: (a: number, b: number) => void;

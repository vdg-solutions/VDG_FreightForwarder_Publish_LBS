...
// Services is the one provider today (implementations/drive/google-oauth.js binds itself here at
// load); the operators never import the provider, only this port. A second provider (Firebase
// Auth, a plain server login) binds the same five functions.
...
/// The provider registers { getCurrentUser, signOut, hasDriveScopeGrant, wasPreviouslySignedIn,
...
export function hasDriveScopeGrant() { return _p().hasDriveScopeGrant(); }

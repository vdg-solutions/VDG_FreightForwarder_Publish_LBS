...
// reconnect chip is the only interactive mint. Bound to implementations/drive/access-token.js.
...
/// The adapter registers { getAccessToken, refreshAccessTokenSilently, recoverFromUnauthorized, reconnectDriveInteractive } once, from the storage bootstrap.
...
export const reconnectDriveInteractive = (...a) => _i().reconnectDriveInteractive(...a);

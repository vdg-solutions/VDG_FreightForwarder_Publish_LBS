...
async function resolveRealParentId(driveFetch, parentId) {
...
async function globalOwnerQuery(driveFetch, name) {
...
async function moveToParent(driveFetch, fileId, newParentId, removeParents = []) {
...
async function dedupeGlobalOwnerFolders(driveFetch, found, parentIdLiteral) {
...
/// What the storage bootstrap binds behind the folder-dedup port.
export const folderDedup = { resolveRealParentId, globalOwnerQuery, moveToParent, dedupeGlobalOwnerFolders };

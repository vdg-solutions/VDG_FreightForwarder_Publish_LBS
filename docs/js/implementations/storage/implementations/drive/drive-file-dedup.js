...
async function getOrCreateFile(driveFetch, uploadFile, parentId, name, initialContent) {
...
/// What the storage bootstrap binds behind the file-dedup port.
export const fileDedup = { getOrCreateFile };

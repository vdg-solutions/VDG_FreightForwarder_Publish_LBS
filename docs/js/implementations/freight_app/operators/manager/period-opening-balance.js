...
import { CLOSING_BALANCES_FIELD, ACCOUNT_FIELD, BALANCE_FIELD } from '../../core_abstractions/ports/period-opening-balance.js';
...
function isPeriodStart(isoDate) {
 ...
 */
async function snapshotClosingBalances(ledgerRepo, accounts, period) {
...
function latestCloseFor(closeRecords, period) {
  return (closeRecords || [])
 ...
 */
function openingBalanceFor(closeRecords, period, accountCode) {
...
/// The operator, bound behind core_abstractions/ports/period-opening-balance.js by the freight_app bootstrap.
export const periodOpeningBalance = { previousPeriod, nextPeriod, periodBounds, dayBefore, periodOfDate, isPeriodStart, snapshotClosingBalances, latestCloseFor, openingBalanceFor };

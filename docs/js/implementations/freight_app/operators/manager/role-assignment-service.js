...
import { publishGrant, unpublishGrant, backfillGrants, grantFileOp } from '../../core_abstractions/ports/grant-publisher.js';
...
import { roleSetToken, resolvePathToFolderId, _aclHas, _driveOpsFromAcl,
  _isNotAuthorizedToChild, _isSharingRateLimited, _buildUserRecord } from '../../core_abstractions/role-assignment-helpers.js';
import { splitInteriorWildcard, grantAcrossForks, grantNewForkToReaders } from '../../core_abstractions/ports/fork-grants.js';
// The raw Drive permission primitives (put/list/delete) live next door, api-first.
import { grantChildFolders, grantEntry, revokeEntry, rollbackGrants } from '../../core_abstractions/ports/grant-cascade.js';

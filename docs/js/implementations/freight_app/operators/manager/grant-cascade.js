...
import { resolvePathToFolderId, _isNotAuthorizedToChild } from '../../core_abstractions/role-assignment-helpers.js';
import { splitInteriorWildcard, revokeAcrossForks } from '../../core_abstractions/ports/fork-grants.js';
...
async function grantChildFolders(api, rootId, email, access, granted, skipped) {
...
async function grantEntry(api, rootId, email, entry, preResolvedFolderId = null) {
...
async function revokeEntry(api, rootId, email, entry) {
...
async function rollbackGrants(api, granted) {
...
/// The operator, bound behind core_abstractions/ports/grant-cascade.js by the freight_app bootstrap.
export const grantCascade = { grantChildFolders, grantEntry, revokeEntry, rollbackGrants };

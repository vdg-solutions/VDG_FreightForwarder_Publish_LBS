...
import { MASTER_REGISTRY } from '../../core_abstractions/master-registry.js';
import { WALLED_TABLES, ROOT_FOLDERS, PENDING_DIR } from '../../core_abstractions/ports/workspace-bootstrap.js';
...
async function bootstrapAclTargetFolders(driveApi, wsRootId) {
...
/// The operator, bound behind core_abstractions/ports/workspace-bootstrap.js by the freight_app bootstrap.
export const workspaceBootstrap = { bootstrapAclTargetFolders };

...
async function assignRepCode(repo) {
...
async function ensureRepCode(user, repo) {
...
async function assertRepCodeAssignable(code, ownerId, repo) {
...
/// The operator, bound behind core_abstractions/ports/rep-code-registry.js by the freight_app bootstrap.
export const repCodeRegistry = { isValidRepCode, assignRepCode, ensureRepCode, assertRepCodeAssignable };

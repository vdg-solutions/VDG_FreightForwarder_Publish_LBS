...
import { ROLE_CACHE_KEY } from '../../../storage/core_abstractions/identity.js';
import { GRANT_AREAS_KEY } from '../../../storage/core_abstractions/grant-file.js';
...
function readCachedIdentityRaw() {
  try {
    const raw = localStorage.getItem(ROLE_CACHE_KEY);
    if (!raw) return null;
...
/// The operator, bound behind core_abstractions/ports/role-cache.js by the freight_app bootstrap.
export const roleCache = { readCachedRole, writeCachedRole, clearCachedRole, readCachedIdentityRaw };

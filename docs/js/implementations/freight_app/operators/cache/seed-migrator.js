...
import { beginMigration, endMigration } from '../../core_abstractions/migration-signal.js';
 ...
 */
async function runSeedMigrations(repo, migrations, _ms = SAFE_AWAIT_DEFAULT_MS) {
...
/// The operator, bound behind core_abstractions/ports/seed-migrator.js by the freight_app bootstrap.
export const seedMigrator = { runSeedMigrations };

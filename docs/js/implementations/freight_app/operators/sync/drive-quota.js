 ...
 */
async function checkDriveQuota(driveApi) {
...
/// The operator, bound behind core_abstractions/ports/drive-quota.js by the freight_app bootstrap.
export const driveQuota = { checkDriveQuota };

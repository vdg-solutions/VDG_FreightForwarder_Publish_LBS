...
import { assignRepCode, assertRepCodeAssignable } from '../core_abstractions/ports/rep-code-registry.js';
...
async function _appendGrant(driveApi, adminFolderId, grant) {
  const { serializeJsonlBundle, parseJsonlBundle } = await import('../../kernel/core_abstractions/util/jsonl-bundle.js');

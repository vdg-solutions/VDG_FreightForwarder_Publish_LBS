...
export async function findLock(repo, periodKey) {
 ...
 */
export async function lockPeriod(repo, periodKey, user) {
 ...
 */
export async function unlockPeriod(repo, periodKey) {
  const prefs = await _readPrefs(repo);

...
// output/web/js.tmp/implementations/ui/bootstrap/views/sales-analytics.js
var KIND_LINE = "pnl_line";
var CHART_BAR_COLOR_REV = "rgba(59,130,246,0.7)";
var CHART_BAR_COLOR_COST = "rgba(248,113,113,0.7)";
var DONUT_COLORS = ["#3b82f6", "#10b981", "#f59e0b", "#ef4444", "#8b5cf6", "#14b8a6", "#f97316", "#6366f1"];
var PERIODS = ["today", "week", "month", "quarter", "year"];
var ACTIVE_PERIOD_IDX = 2;
var _charts = {};
...
function renderKpiRow(kpis) {
  ...
  return cards.map(
    (c) => `<kpi-card label="${c.label}" value="${c.value}" tone="${c.tone}" icon="${c.icon}"></kpi-card>`
  ).join("");
}

...
var MOCK_ALLOCATIONS = [
  {
    ...
    awb_refs: [
      { awb_ref: "180-12345675", pieces: 5, weight_chargeable_kg: 450 },
      { awb_ref: "180-22222220", pieces: 3, weight_chargeable_kg: 310 },
      { awb_ref: "180-33333335", pieces: 8, weight_chargeable_kg: 680 }
    ]
  },
  {
    alloc_id: "alloc-002",
    ...
    awb_refs: [
      { awb_ref: "180-44444440", pieces: 10, weight_chargeable_kg: 900 },
      { awb_ref: "180-55555550", pieces: 4, weight_chargeable_kg: 350 }
    ]
  },
  {
    alloc_id: "alloc-003",
    ...
    awb_refs: [
      { awb_ref: "180-66666660", pieces: 2, weight_chargeable_kg: 180 }
    ]
  }
];
function escHtml(s) {

  ...
  return [
    ...
    { field: "role", headerName: t("commission_rules.col.role"), width: 110 },
    {
      ...
      cellRenderer: (p) => {
        ...
        lbsLabel.textContent = p.value != null ? t("commission_rules.lbs_share", { n: 100 - Number(p.value) }) : t("commission_rules.lbs_share", { n: 100 - DEFAULT_SALES_PCT });

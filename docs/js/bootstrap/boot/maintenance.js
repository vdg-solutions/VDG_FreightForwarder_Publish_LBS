...
export function runBootMaintenance(driveApi, ioPort) {
  ...
  import('../../implementations/freight_app/operators/manager/error-log-store.js')
  ...
  import('../../implementations/freight_app/operators/cache/per-record-migrator.js')
    .then((m) => m.migratePerRecordKinds({
      ...
      trashFile: (fileId, parentId) => import('../../implementations/storage/implementations/drive/drive-file-retire.js')

...
const STATIC_CACHE     = 'vdg-static-v1e1b637';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v1e1b637';
...
// versioned with STATIC_CACHE (a redeploy bumps 1e1b637 → activate drops the old cache →

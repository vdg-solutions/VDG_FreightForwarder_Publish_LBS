...
const STATIC_CACHE     = 'vdg-static-v03a2d5a8';
...
const BOOT_GRAPH = [
  ...
  'js/bootstrap/platform/dev-seams.js',
  ...
  'js/implementations/kernel/core_abstractions/ports/shipment-mode.js',
  ...
  'js/implementations/storage/core_abstractions/identity-cache-keys.js',
  ...
  'js/implementations/storage/implementations/local/tab-ownership.js',
  ...
  'js/implementations/ui/bootstrap/components/sync-attention-modal.js',
  ...
  'js/implementations/ui/bootstrap/helpers/mount-overlay.js',
  ...
  'js/implementations/ui/bootstrap/views/tab-blocked.js',
...
// versioned with STATIC_CACHE (a redeploy bumps 03a2d5a8 → activate drops the old cache →

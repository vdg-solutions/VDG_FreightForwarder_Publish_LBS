...
const STATIC_CACHE     = 'vdg-static-v3b3fed7';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v3b3fed7';
...
// versioned with STATIC_CACHE (a redeploy bumps 3b3fed7 → activate drops the old cache →

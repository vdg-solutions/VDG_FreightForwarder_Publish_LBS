...
const STATIC_CACHE     = 'vdg-static-vbc49f41-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vbc49f41-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps bc49f41-dirty → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v20a1e2d-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v20a1e2d-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps 20a1e2d-dirty → activate drops the old cache →

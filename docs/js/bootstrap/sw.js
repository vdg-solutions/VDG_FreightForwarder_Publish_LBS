...
const STATIC_CACHE     = 'vdg-static-v3d68f41';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v3d68f41';
...
// versioned with STATIC_CACHE (a redeploy bumps 3d68f41 → activate drops the old cache →

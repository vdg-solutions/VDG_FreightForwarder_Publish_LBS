...
const STATIC_CACHE     = 'vdg-static-v98a2e8f';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v98a2e8f';
...
// versioned with STATIC_CACHE (a redeploy bumps 98a2e8f → activate drops the old cache →

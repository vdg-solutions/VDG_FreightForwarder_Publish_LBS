...
const STATIC_CACHE     = 'vdg-static-v8009238';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v8009238';
...
const BOOT_GRAPH = [
  ...
  'js/implementations/freight_app/bootstrap/compose.js',
  'js/implementations/freight_app/core_abstractions/audit-stores.js',
  'js/implementations/freight_app/core_abstractions/master-registry.js',
  'js/implementations/freight_app/core_abstractions/migration-signal.js',
  'js/implementations/freight_app/core_abstractions/ports/drive-quota.js',
  'js/implementations/freight_app/core_abstractions/ports/fork-grants.js',
  'js/implementations/freight_app/core_abstractions/ports/fsm-ingest.js',
  'js/implementations/freight_app/core_abstractions/ports/grant-cascade.js',
  'js/implementations/freight_app/core_abstractions/ports/grant-publisher.js',
  'js/implementations/freight_app/core_abstractions/ports/jobno-lease.js',
  'js/implementations/freight_app/core_abstractions/ports/ledger-poster.js',
  'js/implementations/freight_app/core_abstractions/ports/period-lock-registry.js',
  'js/implementations/freight_app/core_abstractions/ports/period-opening-balance.js',
  'js/implementations/freight_app/core_abstractions/ports/rep-code-registry.js',
  'js/implementations/freight_app/core_abstractions/ports/role-cache.js',
  'js/implementations/freight_app/core_abstractions/ports/sales-analytics-compute.js',
  'js/implementations/freight_app/core_abstractions/ports/seed-migrator.js',
  'js/implementations/freight_app/core_abstractions/ports/shipment-audit.js',
  'js/implementations/freight_app/core_abstractions/ports/shipment-repo.js',
  'js/implementations/freight_app/core_abstractions/ports/shipment-revenue-repo.js',
  'js/implementations/freight_app/core_abstractions/ports/shipment-state-aliases.js',
  'js/implementations/freight_app/core_abstractions/ports/workspace-bootstrap.js',
  'js/implementations/freight_app/core_abstractions/ports/write-gate.js',
  'js/implementations/freight_app/core_abstractions/repo-query.js',
  'js/implementations/freight_app/core_abstractions/role-assignment-helpers.js',
  'js/implementations/freight_app/core_abstractions/roles.js',
  'js/implementations/freight_app/core_abstractions/session-roles.js',
  'js/implementations/freight_app/core_abstractions/wma-engine.js',
  'js/implementations/freight_app/implementations/wasm-loader.js',
  'js/implementations/freight_app/operators/auth/auth-gate.js',
  'js/implementations/freight_app/operators/auth/role-cache.js',
  'js/implementations/freight_app/operators/cache/seed-migrator.js',
  'js/implementations/freight_app/operators/data/shipment-repo.js',
  'js/implementations/freight_app/operators/data/shipment-revenue-repo.js',
  'js/implementations/freight_app/operators/data/write-gate.js',
  'js/implementations/freight_app/operators/fsm-ingest.js',
  'js/implementations/freight_app/operators/jobno-lease.js',
  'js/implementations/freight_app/operators/ledger-poster.js',
  'js/implementations/freight_app/operators/license-boot-flow.js',
  'js/implementations/freight_app/operators/license-gate.js',
  'js/implementations/freight_app/operators/license-messages.js',
  'js/implementations/freight_app/operators/manager/first-run-provision.js',
  'js/implementations/freight_app/operators/manager/fork-grants.js',
  'js/implementations/freight_app/operators/manager/grant-cascade.js',
  'js/implementations/freight_app/operators/manager/grant-publisher.js',
  'js/implementations/freight_app/operators/manager/period-lock-registry.js',
  'js/implementations/freight_app/operators/manager/period-opening-balance.js',
  'js/implementations/freight_app/operators/manager/route-guard.js',
  'js/implementations/freight_app/operators/manager/workspace-bootstrap.js',
  'js/implementations/freight_app/operators/rep-code-registry.js',
  'js/implementations/freight_app/operators/sales-analytics-compute.js',
  'js/implementations/freight_app/operators/shipment-void-delete.js',
  'js/implementations/freight_app/operators/sync/drive-quota.js',
  'js/implementations/freight_app/operators/sync/job-tracker.js',
  'js/implementations/freight_app/operators/sync/shipment-audit.js',
  'js/implementations/freight_app/operators/sync/wma-store.js',
  'js/implementations/freight_app/operators/util/shipment-state-aliases.js',
  'js/implementations/kernel/core_abstractions/i18n/index.js',
  'js/implementations/kernel/core_abstractions/util/dashboard-distribution.js',
  'js/implementations/kernel/core_abstractions/util/email-prefix.js',
  ...
  'js/implementations/kernel/core_abstractions/util/sales-rep-i18n.js',
  'js/implementations/kernel/core_abstractions/util/shipment-phases.js',
  'js/implementations/kernel/core_abstractions/util/shipment-state-resolver.js',
  ...
  'js/implementations/storage/core_abstractions/storage-api.js',
  ...
  'js/implementations/ui/bootstrap/components/orphan-folder-banner-element.js',
  'js/implementations/ui/bootstrap/components/orphan-folder-banner.js',
  ...
  'js/implementations/ui/bootstrap/views/auth/drive-access-gate-screen.js',
...
// versioned with STATIC_CACHE (a redeploy bumps 8009238 → activate drops the old cache →

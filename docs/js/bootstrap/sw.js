...
const STATIC_CACHE     = 'vdg-static-v3e6a172';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v3e6a172';
...
// versioned with STATIC_CACHE (a redeploy bumps 3e6a172 → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-vea5bfaf-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vea5bfaf-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps ea5bfaf-dirty → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-va5a40a3-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-va5a40a3-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps a5a40a3-dirty → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v8cfc08c';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v8cfc08c';
...
// versioned with STATIC_CACHE (a redeploy bumps 8cfc08c → activate drops the old cache →

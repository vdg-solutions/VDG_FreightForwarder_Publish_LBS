...
const STATIC_CACHE     = 'vdg-static-veea91f4';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-veea91f4';
...
// versioned with STATIC_CACHE (a redeploy bumps eea91f4 → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-vb8569cd';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vb8569cd';
...
// versioned with STATIC_CACHE (a redeploy bumps b8569cd → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-vc3953a2-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vc3953a2-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps c3953a2-dirty → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v148052a-dirty';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v148052a-dirty';
...
// versioned with STATIC_CACHE (a redeploy bumps 148052a-dirty → activate drops the old cache →

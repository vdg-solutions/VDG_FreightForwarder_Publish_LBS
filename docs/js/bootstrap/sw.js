...
const STATIC_CACHE     = 'vdg-static-vcc120de';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-vcc120de';
...
// versioned with STATIC_CACHE (a redeploy bumps cc120de → activate drops the old cache →

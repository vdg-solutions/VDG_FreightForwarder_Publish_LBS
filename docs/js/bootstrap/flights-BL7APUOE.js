...
var KIND = "flights";
var KIND_PREFIX = "FLT";
var SEED_URL = "seed/masters/flights.jsonl";
function escHtml(s) {
...
async function render(root) {
  ...
  async function reload() {
    ...
    const listRes = await boundedList(repo, KIND, "flights:list");
    if (!listRes.ok) {
      if (tbody) tbody.innerHTML = "";

...
import { AUDIT_STORE_REVENUE, AUDIT_STORE_SHARED } from './audit-log.js';
 ...
 */
export function recordShipmentChange({ before, after, op }) {
  const log = auditLog();
  if (!log) {
...
export function splitChanges(before, after) {

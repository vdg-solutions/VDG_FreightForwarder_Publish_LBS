...
const STATIC_CACHE     = 'vdg-static-v578799d';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v578799d';
...
// versioned with STATIC_CACHE (a redeploy bumps 578799d → activate drops the old cache →

...
const STATIC_CACHE     = 'vdg-static-v6efb6a6';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v6efb6a6';
...
// versioned with STATIC_CACHE (a redeploy bumps 6efb6a6 → activate drops the old cache →

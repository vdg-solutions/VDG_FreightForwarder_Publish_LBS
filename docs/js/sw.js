...
const STATIC_CACHE     = 'vdg-static-v4255eee';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v4255eee';
...
// versioned with STATIC_CACHE (a redeploy bumps 4255eee → activate drops the old cache →

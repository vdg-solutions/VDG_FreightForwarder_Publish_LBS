...
const STATIC_CACHE     = 'vdg-static-v0d0aced';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v0d0aced';
...
// versioned with STATIC_CACHE (a redeploy bumps 0d0aced → activate drops the old cache →

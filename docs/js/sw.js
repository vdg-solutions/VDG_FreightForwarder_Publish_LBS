...
const STATIC_CACHE     = 'vdg-static-v44fbf2d';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v44fbf2d';
...
// versioned with STATIC_CACHE (a redeploy bumps 44fbf2d → activate drops the old cache →

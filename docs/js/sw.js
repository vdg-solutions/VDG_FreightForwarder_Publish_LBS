...
const STATIC_CACHE     = 'vdg-static-v3a47f2c';
...
const DRIVE_META_CACHE = 'vdg-drive-meta-v3a47f2c';
...
// versioned with STATIC_CACHE (a redeploy bumps 3a47f2c → activate drops the old cache →
